...
# (str) Package name
package.name = mobilegame

# (str) Package domain (needed for android/ios packaging)
package.domain = org.gamedev
...
source.exclude_dirs = tests, bin, venv, docs, .buildozer, .git

# (list) List of exclusions using pattern matching
# Do not prefix with './'
source.exclude_patterns = license,images/*/*.jpg,.buildozer/*,.git/*
...
requirements = python3,pygame,sdl2_ttf,kivy
...
android.presplash_color = #F0F0F0
